@php
    ...
    $is_green = ($current_route === 'front.product.details' || $current_route === 'front.gift.details'); // use your route name
@endphp
    ...
    <header class="sticky-header <?= $is_green ? 'theme-green' : 'theme-white' ?>">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="navbar_left">
                <a href="{{ route('front.home') }}"><img class="header_logo"
                    src="{{ $is_green 
                            ? asset('public/front/images/header-green.svg') 
                            : asset('public/front/images/header-logo.svg') }}"
                    alt="Logo"></a>
            </div>
          ...
          <span class="toggler-icon"></span>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="mainNavbar">
                <ul class="mx-auto nav_links me-0">
                    <li>
                ...
                <!--    <a href=""><img src=" <?= $is_green ? asset('public/front/images/serach-icon-black.svg') : asset('public/front/images/search-icon.svg') ?>"-->
                <!--            alt="Search"></a>-->
                <!--    <a href=""><img src="<?= $is_green ? asset('public/front/images/user-icon-black.svg') : asset('public/front/images/user-icon.svg') ?>"-->
                <!--            alt="User"></a>-->
                <!--    <a href=""><img src="<?= $is_green ? asset('public/front/images/cart-icon-black.svg') : asset('public/front/images/cart-icon.svg') ?>"-->
                <!--            alt="Cart"></a>-->
                <!--</div>-->
...
const languages = [
      ...
      { code: 'or', name: 'ଓଡ଼ିଆ (Odia)' }, { code: 'ps', name: 'پښتو (Pashto)' }, { code: 'fa', name: 'فارسی (Persian)' }, { code: 'pl', name: 'Polski (Polish)' }, { code: 'pt', name: 'Português (Portuguese)' }, { code: 'pa', name: 'ਪੰਜਾਬੀ (Punjabi)' }, { code: 'ro', name: 'Română (Romanian)' },  { code: 'sm', name: 'Gagana Sāmoa (Samoan)' }, { code: 'gd', name: 'Gàidhlig (Scots Gaelic)' },
