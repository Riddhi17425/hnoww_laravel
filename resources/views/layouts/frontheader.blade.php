...
$current_route === 'front.order.details' || $current_route === 'front.guest.order.access' || $current_route === 'front.guest.order.details' || $current_route === 'front.get.forgot.password' || $current_route === 'front.get.reset.password' );
