...
<div class="modal fade audio_modal" id="loginRequiredModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
    data-bs-keyboard="false" tabindex="-1" aria-labelledby="productInquiryLabel" aria-hidden="true">
...
">
    <div style="max-width: 1200px; margin: auto; display: flex; justify-content: space-between; align-items: center;">
        <p style="margin: 0;">
            We use cookies to enhance your browsing experience, serve personalized content, and analyze our traffic. <a
                href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#cookiePolicy">Learn more about our
                cookie policy.</a>
        </p>
        <div>
                    ...
                    <div class="ct_form" id="cookie-policy-modal" class="cookie-policy-modal">
                        ...
                        <ul>
                            <li><strong>Functional Cookies</strong>: Essential for website functionality, enabling
                                ...
                                Examples include session cookies and consent preferences. Duration: Typically
                                session-based or up to 1 year.</li>
                            <li><strong>Analytics Cookies</strong>: Help us understand visitor interactions through
                                anonymous data (e.g., page views, navigation patterns) to improve performance. Duration:
                                Up to 2 years.</li>
                        ...
                        <ul>
                            <li><strong>Cookie Consent Tool</strong>: Accept all, reject non-essential, or customize
                                cookie types (functional, analytics, advertisement) via the consent dialog. Revisit
                                preferences by clearing your browser cookies or using the consent dialog when it
                                reappears.</li>
                            <li><strong>Browser Settings</strong>: Block or delete cookies via your browser settings,
