...
<section class="mt_120">
    <div class="container">
        <div class="section_header">
            ...
            <h2 class="title_60">HNOWW’s Rakhi Edition</h2>
        </div>

        <div class="exists_content">
            <div class="col-lg-10 m-auto text-center">
                <p class="sub_head_inter">
                    A thread lasts a few days. What it holds between two people doesn't.
                    That's what this collection was built around: pieces a sibling keeps reaching for, long after the day itself has passed.<br>
                   
                </p>

                <p class="sub_head_inter"> Every gift carries its own story card, a small note that speaks for itself.</p>

            </div>
        </div>

        <div class="mt-5">
            <img class="img-fluid w-100" src="{{ asset('public/images/front/Raksha-Bandhan/Rakhi-Edition.webp') }}" alt="Rakhi Edition">
        </div>
    </div>
</section>
...
<section class="mt_120 mb_120">
    <div class="container">
        ...
        <div class="faq_cont">
            <div class="accordion" id="accordion-rakhi-faq">
                ...
                <div class="faq_cont_acco">
                    ...
                    <div id="collapse-faq-3" class="accordion-collapse collapse"
                        data-bs-parent="#accordion-rakhi-faq">
                        <div class="accordion-body">
                            <p class="mb-0 text-muted">Yes, we do offer same-day delivery on select ready-to-ship items. Please check with our team for availability.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="faq_cont_acco">
                    ...
                    <div id="collapse-faq-5" class="accordion-collapse collapse"
                        data-bs-parent="#accordion-rakhi-faq">
                        <div class="accordion-body">
                            <p class="mb-0 text-muted">Our team can recommend the perfect gifts based on the recipient's taste and style, from memory boxes to luxury candles and ceremonial objects.</p>
                        </div>
                    </div>
                </div>
