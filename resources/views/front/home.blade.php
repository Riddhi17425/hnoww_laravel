                ...
                <div class="gesture_filter">
                    <div class="gesture_filter_child">
                        ...
                        <select id="gift_for_filter" class="dropdown">
                            <option value="" {{ request('gift_for') == '' ? 'selected' : '' }}> Select Gift For
                            </option>
                            @foreach (config('global_values.gift_for') as $key => $value)
                                <option value="{{ $key }}"
                                    {{ request('gift_for') == $key ? 'selected' : '' }}>{{ $value }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="gesture_filter_child">
                        ...
                        <select id="to_celebrate_filter" class="dropdown">
                            ...
                            @foreach (config('global_values.to_celebrate') as $key => $value)
                                <option value="{{ $key }}"
                                    {{ request('to_celebrate') == $key ? 'selected' : '' }}>{{ $value }}
                                </option>
                            @endforeach
                        </select>
                    </div>
            ...
            <div class="row gy-4 gy-md-0">
                <div class="col-md-4">
                    <div class="collection_box">
                        <div class="">
                            <a href="{{ route('front.list', 'luxury-gifts-for-her') }}"><img
                                    class="img-fluid mb-2 mb-md-4"
                                    src="{{ asset('public/images/front/collections1.webp') }}" alt="collections1"
                                    loading="lazy"></a>
                        </div>
                        <h3 class="sub_head">For Her {{-- — {{$herProduct[0]->product_name ?? ''}} --}}</h3>
                        <p>
                            @if (isset($herProduct[0]->short_description))
                                {!! $herProduct[0]->short_description !!}
                            @endif
                        </p>
                        <a href="{{ route('front.list', 'luxury-gifts-for-her') }}" class="com_btn">Explore Her
                            World</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="collection_box">
                        <div class="">
                            <a href="{{ route('front.list', 'luxury-gifts-for-him') }}"><img
                                    class="img-fluid mb-2 mb-md-4"
                        ...
                        <p>
                            @if (isset($himProduct[0]->short_description))
                                {!! $himProduct[0]->short_description !!}
                            @endif
                        </p>
                        <a href="{{ route('front.list', 'luxury-gifts-for-him') }}" class="com_btn">Explore Him
                            World</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="collection_box">
                        <div class="">
                            <a href="{{ route('front.list', 'luxury-home-decor') }}"><img
                                    class="img-fluid mb-2 mb-md-4"
                        ...
                        <p>
                            @if (isset($homeProduct[0]->short_description))
                                {!! $homeProduct[0]->short_description !!}
                            @endif
                        </p>
        ...
        <div class="container">
            <div class="magic_wrapper">
                ...
                <div class="text-end magic_wrapper_logo">
                    <img src="{{ asset('public/images/front/footer-logo.svg') }}" loading="lazy"
                        alt="Home Magic Left Image" class="img-fluid">
                </div>

                <!-- 2️⃣ Center image (scale 0 → 1) -->
                <div class="magic_wrapper_center">
                    <img src="{{ asset('public/images/front/home_magic.webp') }}" loading="lazy"
                        alt="Home Magic Center Image" class="img-fluid">
                ...
                <div>
                    ...
                    <p>
                        ...
                        Form, material, and shadow are considered with care, designed to slow the moment, focus the
                        mind,
                ...
                @foreach ($desiredProductsArray as $key => $val)
                    ...
                    <span>Enquire Now</span>
                        ...
                        data-bs-target="#loginRequiredModal" @endauth> --}}
                                ...
                                <button type="button" class="desire_box_top_child_inner add_to_cart_btn"
                                    data-product-id="{{ $val->id }}">
                                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none">
                                        <path
                                            d="M0.5 4.5H18.5M0.5 4.5V16.5C0.5 17.6046 1.39543 18.5 2.5 18.5H16.5C17.6046 18.5 18.5 17.6046 18.5 16.5V4.5M0.5 4.5L2.46327 1.00974C2.64039 0.69486 2.97357 0.5 3.33485 0.5H15.6652C16.0264 0.5 16.3596 0.69486 16.5367 1.00974L18.5 4.5M12.5 8.5C12.5 10.1569 11.1569 11.5 9.5 11.5C7.8431 11.5 6.5 10.1569 6.5 8.5"
...
<section class="mt_120">
            ...
            <div class="layout-wrapper-Socials">
                ...
                <img src="{{ asset('public/images/front/editions2.webp') }}" alt="Grid Image 6" class="grid-image"> --}}
                    ...
                    @else
                        ...
                        @for ($i = 1; $i <= 6; $i++)
                            <img src="{{ asset('public/images/front/editions2.webp') }}"
                                alt="Grid Image {{ $i }}" class="grid-image">
                        @endfor
                    @endif
                </div>
            </div>
    ...
    <div class="modal fade audio_modal" id="productInquiry" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="productInquiryLabel" aria-hidden="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="ct_input">
                                            ...
                                            <input
                                                style="background-color: #8c8a721c !important;color: var(--gold-color);"
                                                type="text" class=" fw-medium" id="product_name" value=""
                                                disabled>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ct_input">
                                            ...
                                            <textarea name="message" placeholder="Enter Message" rows="1" class=" @error('message') is-invalid @enderror">{{ old('message') }}</textarea>
                                            @error('message')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
