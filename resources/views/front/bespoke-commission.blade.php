        ...
        <div class="cta_ftwrapper">
            ...
            <div>
                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#bespokeCommission"
                    class="btn_2">Begin Your Journey</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <form method="POST" action="{{ route('front.store.bespoke.commission.request') }}"
                        id="bespokeCommissionForm" class="ct_form">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="ct_input">
                                    ...
                                    <input type="text" name="bc_full_name" placeholder="Enter your Full Name"
                                        id="bc_full_name"
                                        oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '').replace(/\s+/g, ' ').trimStart();"
                            ...
                            <div class="col-lg-6">
                                <div class="ct_input">
                                    ...
                                    <input type="email" placeholder="Enter your Email Address" name="bc_email"
                                        id="bc_email" value="{{ old('bc_email') }}">
                            ...
                            <div class="col-lg-6">
                                <div class="ct_input">
                                    ...
                                    <input type="text" name="bc_phone" placeholder="Enter your WhatsApp Phone Number"
                                        id="bc_phone"
                                        oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 15);"
                                        value="{{ old('bc_phone') }}">
                            ...
                            <div class="col-lg-6">
                                <div class="ct_input">
                                    ...
                                    <select name="bc_timeline" id="bc_timeline">
                                        ...
                                        <option value="{{ $key }}" {{ old('bc_timeline') == $key ? 'selected' : '' }}>
                                            {{ $value }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="ct_input">
                                    <label class="sub_head">Type of Commission <span
                                            class="text-danger">*</span></label>
                                    <select name="bc_type_of_commission" id="bc_type_of_commission">
                                        <option value="">Select</option>
                                        @foreach(config('global_values.commission_type') as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('bc_type_of_commission') == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                        @endforeach
                                        <option value="other"
                                            {{ old('bc_type_of_commission') == 'other' ? 'selected' : '' }}>Other
                                        </option>
                                    </select>
                                    @error('bc_type_of_commission') <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            </div>

                            <!-- Other Commission Text Field (Initially hidden) -->
                            <div class="col-lg-6" id="other_commission_field"
                                style="display: {{ old('bc_type_of_commission') == 'other' ? 'block' : 'none' }};">
                                <div class="ct_input">
                                    <label class="sub_head">Please specify</label>
                                    <input type="text" name="bc_type_of_commission_other"
                                        placeholder="Enter Type of Commission"
                                        value="{{ old('bc_type_of_commission_other') }}">
                                    @error('bc_type_of_commission_other') <small
                            ...
                            <div class="col-12">
                                <div class="ct_input">
                                    <label class="sub_head">What are you hoping to create ? <span
                                            class="text-danger">*</span></label>
                                    <textarea name="bc_customer_hoping_to_create" placeholder="Enter Message"
                                        rows="1">{{ old('bc_customer_hoping_to_create') }}</textarea>
                                    @error('bc_customer_hoping_to_create') <small
                                        class="text-danger">{{ $message }}</small> @enderror
                                </div>
                            </div>
