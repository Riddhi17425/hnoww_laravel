                            ...
                            <div class="ct_input">
                                <div class="options">
                                    <label class="remember-me" for="remember">
                                        <input class="mt-0" type="checkbox" id="remember" name="remember"
                                            {{ old('remember') ? 'checked' : '' }} />
                                        <span>Remember me</span>
                                    </label>
                                    <div class="forgot-password">
                                        <a href="{{route('front.get.forgot.password')}}"
                                            style="color:var(--dark-900);">Forgot Password?</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="ct_form">
                        ...
                        <form method="POST" id="registerForm" action="{{ route('front.register.post') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <!-- <div class="ct_input">
                                            <input type="date" name="dob" id="dob" value="{{ old('dob') }}"  placeholder="Enter Email Address">
                                            @error('dob') <small class="text-danger">{{ $message }}</small> @enderror
                                        </div> -->
                                    <div class="ct_input">
                                        <input type="text" name="dob" id="dob" value="{{ old('dob') }}"
                                            placeholder="Enter Date of Birth" onfocus="(this.type='date')"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="ct_input password_wrap">
                                        ...
                                        <span class="toggle_password" onclick="togglePasswordSvg('r_password', this)">
                                            <!-- 👁 Eye (show) -->
                                            <svg class="eye-open" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
