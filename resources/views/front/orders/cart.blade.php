                            ...
                            <tbody id="cart_item_list">
                                <form action="" method="POST" id="cart-update-form">
                                    ...
                                    <tr id="cart-row-{{$cart->id}}" class="cart-item-row">
                                        ...
                                        <td>
                                            <div class="increment_decrement_area">
                                                <div class="increment_decrement"
                                                    ...
                                                    <button class="inc_btn" type="button" data-call="cart">+</button>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td><a href="javascript:void(0);" class="btn btn-danger delete-cart-item"
                                                data-id="{{ $cart->id }}"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    @endforeach
                                    @else
                                    <tr>
