...
<section class="hero-section_inner">
    ...
    <div class="hero_content_inner">
        ...
        <p class="para mb-0">Hospitality is rarely about perfection. It is about the specific vibration of a room when people feel held by their surroundings. It is the weight of a fork, the scent of unlit wax, and the way light catches the rim of a glass</p>
    </div>
</section>
<section class="mt_60">
    <div class="container">
            ...
            @if(isset($journal) && is_countable($journal) && count($journal) > 0)
                {{-- @foreach($journal as $key => $val)
                    <div class="month_box">
                        ...
                        @if(date('F') === $val->month_name)
                            <a href="#">
                                <svg class="green_svg" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19 1L1 19M19 1H5.15385M19 1V14.8462" stroke="#0D5E4C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </a>
                        @else
                            <span>
                ...
                @foreach($journal as $key => $val)
                    ...
                    <div class="month_box">
                        ...
                        @if($journalMonthNumber <= $currentMonthNumber)
                            <a href="#month-{{ $journalMonthNumber }}">
                                <svg class="green_svg" width="20" height="20" viewBox="0 0 20 20">
                                    <path d="M19 1L1 19M19 1H5.15385M19 1V14.8462"
                                        stroke="#0D5E4C" stroke-width="2"
        ...
        <div class="row g-4 g-xxl-5">
            @if(isset($journal) && is_countable($journal) && count($journal) > 0)
                        ...
                        <div class="row gy-3 gy-md-0">
                            <div class="col-md-6">
                                <div class="montheditions_lt">
                                    <img class="img-fluid" src="{{asset('public/images/admin/journal/detail_images/'. $val->detail_img)}}" alt="{{ $val->month_name ?? 'month image'}}">
                ...
                @endphp
                    ...
                    @if($journalMonthNumber <= $currentMonthNumber)
                    <div class="col-md-6" id="month-{{ $journalMonthNumber }}">
                        <div class="row gy-3 gy-md-0">
                            <div class="col-md-6">
                                <div class="montheditions_lt">
                                    <img class="img-fluid"
