    ...
    <div class="container-xxl">
        <div class="row align-items-center">
            ...
            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center
                ...
                <h3 class="fw-bold mb-0">Product Image Details</h3>
                <a href="{{ route('admin.product-images.create') }}">
                    <button class="btn btn-primary">
                        <i class="icofont-plus-circle me-2"></i>Add Product Images
                    </button>
                </a>
            </div>
        </div>
...
<script>
window.APP_URLS = {
    getProductImages: "{{ route('admin.product-images.fetch') }}",
    deleteProductImages: "{{ route('admin.product-images.delete', [':id']) }}",
