    ...
    <form action="{{ route('admin.blessings.update', $blessing->id) }}" method="POST" enctype="multipart/form-data" id="vlessingForm">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="slug" class="form-control" value="{{ old('slug', $blessing->slug ?? '') }}" placeholder="Auto-generated if left blank">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="alt_text"
                        class="form-control"
                        value="{{ old('alt_text', $blessing->alt_text ?? '') }}"
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="meta_title" class="form-control" value="{{ old('meta_title', $blessing->meta_title ?? '') }}">
                @error('meta_title') <span class="text-danger">{{ $message }}</span> @enderror
            </div>

            <div class="col-md-6">
                <label class="form-label">Meta Description</label>
                <textarea name="meta_description" class="form-control" rows="1">{{ old('meta_description', $blessing->meta_description ?? '') }}</textarea>
