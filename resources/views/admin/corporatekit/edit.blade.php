...
@section('title', 'Edit Corporate Kit')

@section('content')
<div class="container-xxl">
    <div class="row mb-3">
        <div class="col-md-6">
            <h3>Edit Corporate Kit</h3>
        </div>
    ...
    <form action="{{ route('admin.corporate-kits.update', $corporateKit->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text"
                       name="title"
                       class="form-control"
                       value="{{ old('title', $corporateKit->title) }}">
            ...
            <div class="col-md-3">
                ...
                <input type="text"
                       name="price_range"
                       class="form-control"
                       value="{{ old('price_range', $corporateKit->price_range) }}">
            ...
            <div class="col-md-3">
                ...
                <input type="number"
                       name="moq"
                       class="form-control"
                       value="{{ old('moq', $corporateKit->moq) }}">
            ...
            <div class="col-md-12">
                ...
                <textarea name="short_description"
                          ...
                          class="form-control"
                          rows="4">{{ old('short_description', $corporateKit->short_description) }}</textarea>
            ...
            <div class="col-md-12">
                ...
                <textarea name="large_description"
                          id="large_description"
                          class="form-control"
                          rows="4">{{ old('large_description', $corporateKit->large_description) }}</textarea>
