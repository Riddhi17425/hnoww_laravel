...
class FrontController extends Controller
{
    ...
    public function getProductDetails(Request $request, $productSlug){
        $product = Product::select('id', 'category_id', 'product_name', 'product_price', 'short_description', 'list_page_img', 'is_active', 'deleted_at', 'large_description', 'dimensions', 'detail_page_imgs', 'moq', 'short_note')->where('product_url', $productSlug)->isActive()->notDeleted()->first();
